...
def text_to_speech():
        ...
        # os.system("mpg123 "+"text.mp3")          #this will play using playsound
        """from playsound import playsound         #if we want to play in vs code
        playsound("text.mp3")"""
        os.system("start text.mp3")  # Opens the file using the default media player
